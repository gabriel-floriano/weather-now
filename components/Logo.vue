<template>
    <svg
    id="Layer_1" version="1.2" baseProfile="tiny" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
	 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	 x="0px" y="0px" width="108px" height="16px" viewBox="0 0 108 16" xml:space="preserve">
        <g>
            <g>
                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="8" y1="8" x2="8" y2="0">
                    <stop  offset="0" style="stop-color:#FA5E5A"/>
                    <stop  offset="1" style="stop-color:#FF8800"/>
                    <a:midPointStop  offset="0" style="stop-color:#FA5E5A"/>
                    <a:midPointStop  offset="0.5" style="stop-color:#FA5E5A"/>
                ...
                <path
                    fill="#CF5278" d="M0.085,9c0.072,0.574,0.185,1.137,0.372,1.667h15.086c0.188-0.53,0.3-1.093,0.372-1.667H0.085z M8,16
            ...
            <g>
                <g>
                    <path
                        fill="#CF5278" d="M85.852,3.757h1.127v8.612h-1.307l-4.378-6.957H81.27v6.957h-1.127V3.757h1.379l4.306,6.956h0.024V3.757z
                        "/>
                    <path
                        fill="#CF5278" d="M92.561,12.596c-3.215,0-4.197-2.674-4.197-4.533c0-1.859,0.982-4.533,4.197-4.533
                    ...
                    <path
                        fill="#CF5278" d="M100.529,12.369h-1.225l-2.242-8.612h1.26l1.607,7.004h0.023l1.932-7.004h1.27l1.932,7.004h0.023
                        l1.607-7.004H108l-2.266,8.612h-1.225l-1.967-7.136h-0.023L100.529,12.369z"/>
                </g>
                <g>
                    <path
                        fill="#B2B2B2" d="M24.29,12.306h-1.224l-2.243-8.611h1.259l1.607,7.004h0.024l1.931-7.004h1.271l1.931,7.004h0.024
                    ...
                    <path
                        fill="#B2B2B2" d="M42.23,9.799l-0.899,2.507h-1.199l3.238-8.611h1.319l3.118,8.611h-1.271l-0.852-2.507H42.23z
                    ...
                    <path
                        fill="#B2B2B2" d="M72.747,12.306h-1.164V3.694h3.982c1.414,0,2.83,0.492,2.83,2.314c0,1.271-0.648,1.739-1.199,2.063
